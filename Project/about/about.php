			...
			<div class="inner-main-content">
					...
					<div id="about-person" class="container">
						...
						<ul>
                                                        ...
                                                        <li>Database interaction with backend</li>
                                                        <li>AJAX queries</li>
                                                </ul>
                                                <p>I am almost finished my second bachelor's degree in computer science after first having
                                                received one in 2011 in Civil Engineering.  When not working, I enjoy traveling and finding
                                                the simpler things in life.</p>
                                        </div> 
					<div id="about-person" class="container">
					...
					<div id="about-person" class="container">
                                                <img src="../images/travis.png"alt="Travis Jones">
                                                <h2>Travis Jones</h2>
												<ul>
                                                        <li>Search overlay, Categories page, Browse All page</li>
                                                        <li>Javascrip with AJAX</li>
                                                        <li>PHP with SQL</li>
                                                </ul>
                                                <p>I'm graduating from UNF with a BS in Computer Science in Spring 2019. I like reading the news, playing video games, and talking about weightlifting.</p>
                                        </div> 
					<div id="about-person" class="container">
